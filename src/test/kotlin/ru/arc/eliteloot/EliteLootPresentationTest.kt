...
class EliteLootPresentationTest : FreeSpec({
    ...
    "ground effects outlive the case timer and end when their item disappears" {
        eliteEffectFinished(true, true, 12000) shouldBe false
        eliteEffectFinished(true, false, 2) shouldBe true
        eliteEffectFinished(false, true, 2) shouldBe true
        eliteEffectFinished(true, null, 38) shouldBe false
        eliteEffectFinished(true, null, 40) shouldBe true
    }
