package arc.arc.common.treasure;

import arc.arc.common.treasure.impl.SubPoolTreasure;
import arc.arc.common.treasure.impl.TreasureCommand;
import arc.arc.common.treasure.impl.TreasureEnchant;
...
public abstract class Treasure {
    ...
    private static final Map<String, Class<? extends Treasure>> types = Map.of(
            ...
            "ae-enchant", TreasureEnchant.class
    );
