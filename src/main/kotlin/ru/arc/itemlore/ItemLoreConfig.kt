...
internal data class ItemLoreSettings(
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = mapOf(
            ...
            "editor-body" to "<#e8dfd2>Добавляйте строки кнопкой ниже, до 80 видимых символов в каждой. Пустое поле удаляет строку. Цена: <white><price></white> за изменённый символ, включая коды оформления, и предмет в стопке.",
            "editor-colors" to "<#e8dfd2>Цвета: <white>&a</white>, <white>&c</white>, <white>&#RRGGBB</white>. Жирный: <white>&l</white>, сброс: <white>&r</white>. Для буквального & введите <white>&&</white>. Результат виден в предпросмотре.",
            ...
            "preview-before" to "<white>Было",
            "preview-after" to "<white>Станет",
            "preview-blank-row" to "<#e8dfd2>(пустая строка)",
            "preview-missing-row" to "<#e8dfd2>—",
            "preview-title" to "<#e8dfd2>Проверьте описание",
            "preview-body" to "<#e8dfd2>Наведите курсор на название предмета, чтобы увидеть его целиком. Стоимость: <white><price></white>.",
