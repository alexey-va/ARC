...
internal data class ItemLoreSettings(
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = mapOf(
            ...
            "too-many-rows" to "<#e8dfd2>У предмета больше 6 строк описания. Лев не будет обрезать их.",
            "row-too-long" to "<#e8dfd2>В одной строке больше 80 символов. Лев не будет обрезать описание.",
            "input-invalid" to "<#e8dfd2>Используйте до 80 символов в строке без переносов.",
            ...
            "editor-body" to "<#e8dfd2>Введите до 6 строк по 80 символов. Пустые поля и поля только с пробелами считаются пустыми. Каждое изменение стоит <white><price></white> за символ и предмет в стопке.",
            "line-label" to "<white>Строка <number>",
            "preview-label" to "<white>Посмотреть",
