...
internal fun claimGuideBorderOrigin(eye: Location, offset: Double = 0.0, snapBlocks: Int = 0): Location =
    eye.clone().apply { y = claimGuideBorderY(eye.y, snapBlocks, offset); yaw = 0f; pitch = 0f }
