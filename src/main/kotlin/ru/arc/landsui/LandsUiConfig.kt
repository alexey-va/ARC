...
class LandsUiConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "claim-display-tooltip" to "<#e8dfd2>Настроить высоту сетки и голограммы.",
            "claim-display-title" to "<#9bd48d>Отображение подсказки",
            "claim-display-body" to "<#e8dfd2>Сетка: <#9bd48d><grid><newline><#e8dfd2>Голограмма: <#86dcf1><label><newline><newline><#aaa49a>Шаг изменения — половина блока.",
            ...
            "claim-display-reset" to "<#aaa49a>Сбросить высоту",
