...
class LandsUiConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            "root-title" to "<#ffc247><bold>Поселения",
            "root-body" to "<#e5f1f5>Выберите поселение — оно станет текущим для действий.<newline><#9aaab2>Поселений: <#e5f1f5><count>   <#9aaab2>Текущее: <#5ee39c><selected>",
            ...
            "details-title" to "<#ffc247><bold><land>",
            "details-body" to "<#5ee39c>● Текущее поселение<newline><#9aaab2>Роль  <#e5f1f5><role><newline><#9aaab2>Территория  <#e5f1f5><chunks>/<max_chunks> чанков<newline><#9aaab2>Участники  <#e5f1f5><members>/<max_members><newline><#9aaab2>Баланс  <#e5f1f5><balance> монет",
            ...
            "create-title" to "<#ffc247><bold>Новое поселение",
            ...
            "created-title" to "<#5ee39c><bold>Поселение создано",
            ...
            "rename-title" to "<#ffc247><bold>Переименовать · <land>",
            "rename-body" to "<#e5f1f5>Введите новое название: 5–24 символа без пробелов.",

            "members-title" to "<#ffc247><bold>Участники · <land>",
            ...
            "add-title" to "<#ffc247><bold>Добавить · <land>",
            ...
            "remove-title" to "<#ffc247><bold>Убрать участника",
            ...
            "territory-title" to "<#ffc247><bold>Территория · <land>",
            ...
            "mainblock-title" to "<#ffc247><bold>Главный блок · <land>",
            ...
            "guide-title" to "<#ffc247><bold>Как работают поселения",
            ...
            "guide-create-title" to "<#ffc247><bold>Создание поселения",
            ...
            "guide-expand-title" to "<#ffc247><bold>Расширение территории",
            ...
            "guide-members-title" to "<#ffc247><bold>Участники",
            ...
            "guide-commands-title" to "<#ffc247><bold>Команды Lands",
            ...
            "danger-title" to "<#ffc247><bold>Удаление · <land>",
