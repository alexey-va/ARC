...
class LandsUiConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "region-tool-lore-menu" to "<#aaa49a>Shift + нажми на кнопку — создать",
            "region-tool-lore-reset" to "<#aaa49a>Shift + ПКМ мимо кнопки — сбросить",
            ...
            "region-controls" to "<#aaa49a>ЛКМ/ПКМ — углы • Shift + нажми по кнопке • Shift+ПКМ — сброс",
            ...
            "unclaim-body" to "<#e8dfd2>Снять защиту с чанка <#d7b486><chunk_x>, <chunk_z><#e8dfd2> в поселении <#d7b486><land><#e8dfd2>?<newline><#aaa49a>Команда Lands будет отправлена от вашего имени.",
            ...
            "guide-commands-body" to "<#aaa49a>Выбрать поселение<newline><#e8dfd2>/lands edit НАЗВАНИЕ<newline><newline><#aaa49a>Присоединить текущий чанк<newline><#e8dfd2>/lands claim<newline><newline><#aaa49a>Добавить игрока<newline><#e8dfd2>/lands trust НИК<newline><newline><#aaa49a>Удалить выбранное поселение<newline><#e8dfd2>/lands delete<newline><newline><#ff6b61>Перед удалением обязательно проверьте текущее поселение.",
