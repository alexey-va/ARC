...
class LandsUiConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "claim-display-body" to "<#aaa49a>Сетка  <#9bd48d><grid>  •  <radius> чанков<newline><#aaa49a>Высота  <#e8dfd2><snap><newline><#aaa49a>Тонкая сетка  <#86dcf1><color><newline><#aaa49a>Вертикальные линии  <#e8dfd2><posts><newline><#aaa49a>Голограмма  <#e8dfd2><label><newline><newline><#77736d>Сетка двигается по 1 блоку, голограмма — по 0,5.",
            ...
            "claim-display-reset" to "<#aaa49a>Сбросить всё",
