...
class LandsUiConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "root-body" to "<#e8dfd2>Выберите поселение — оно станет текущим для действий.<newline><#e8dfd2>Текущее: <#9bd48d><selected><newline><#e8dfd2>Всего поселений: <#e8dfd2><count>",
            ...
            "guide-body" to "<#e8dfd2>Текущее поселение — это цель команд Lands.<newline><#e8dfd2>В этом меню оно всегда отмечено галочкой ✔, а при открытии карточки выбирается явно. Поэтому действие не уйдёт в другое поселение.<newline><newline><#e8dfd2>Выберите тему — внутри есть пошаговое объяснение и нужные кнопки.",
            ...
            "guide-create-body" to "<#d7b486>1. <#e8dfd2>Встаньте в чанк будущей базы.<newline><#d7b486>2. <#e8dfd2>Нажмите «Создать поселение» и введите название.<newline><#d7b486>3. <#e8dfd2>Первый чанк присоединится бесплатно.<newline><#d7b486>4. <#e8dfd2>Новое поселение станет текущим и откроется отдельная карточка результата.<newline><newline><#e8dfd2>Другие чанки не присоединяются автоматически.",
            "guide-expand-title" to "<#86dcf1>Расширение территории",
            "guide-expand-body" to "<#d7b486>1. <#e8dfd2>Откройте нужное поселение — оно станет текущим.<newline><#d7b486>2. <#e8dfd2>Встаньте в соседний свободный чанк.<newline><#d7b486>3. <#e8dfd2>Откройте «Территория и дом» и присоедините чанк.<newline><newline><#e8dfd2>Первый чанк бесплатный. Следующие стоят монет, цена постепенно растёт. Лимит виден в карточке поселения.<newline><newline><#e8dfd2>Ручная команда: <#d7b486>/lands claim<#e8dfd2>. Обычная /claim для расширения не подходит.",
            "guide-members-title" to "<#86dcf1>Участники",
            "guide-members-body" to "<#d7b486>Добавить:<#e8dfd2> откройте поселение → «Участники» → «Добавить игрока». Можно выбрать игрока онлайн или ввести точный ник.<newline><newline><#d7b486>Удалить:<#e8dfd2> нажмите участника в списке и подтвердите действие.<newline><newline><#e8dfd2>Лимит участников показан рядом со списком.",
            "guide-commands-title" to "<#86dcf1>Команды Lands",
            "guide-commands-body" to "<#e8dfd2>Выбрать поселение<newline><#e8dfd2>/lands edit НАЗВАНИЕ<newline><newline><#e8dfd2>Присоединить текущий чанк<newline><#e8dfd2>/lands claim<newline><newline><#e8dfd2>Добавить игрока<newline><#e8dfd2>/lands trust НИК<newline><newline><#e8dfd2>Удалить выбранное поселение<newline><#e8dfd2>/lands delete<newline><newline><#ff6b61>Перед удалением обязательно проверьте текущее поселение.",
