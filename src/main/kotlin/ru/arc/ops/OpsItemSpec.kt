...
object OpsItemSpec {
    ...
    private val knownItemsAdder: Map<String, Pair<Material, Int>> =
        mapOf(
            ...
            "arc:change_category" to (Material.COMPASS to 11019),
            "arc:sort" to (Material.HOPPER to 11022),
            "arc:warp_list" to (Material.CYAN_STAINED_GLASS_PANE to 11020),
            "arc:auction" to (Material.RED_STAINED_GLASS_PANE to 11021),
            "arc:scifichest_4" to (Material.IRON_INGOT to 73023),
            "arc:scifichest_5" to (Material.IRON_INGOT to 73024),
            "arc:scifichest_6" to (Material.IRON_INGOT to 73025),
            "arc:scifichest_7" to (Material.IRON_INGOT to 73026),
            "arc:scifichest_8" to (Material.IRON_INGOT to 73027),
            "arc:scifichest_10" to (Material.IRON_INGOT to 73029),
            "iageneric:bronze_coin" to (Material.STICK to 11135),
            "iageneric:silver_coin" to (Material.STICK to 11136),
