...
class HelpCenterConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "category-activities-tooltip" to "<#dcecf2>События, дуэли, подземелья и фермы.",
            ...
            "category-travel-title" to "<#46d9ee>Перемещения",
            ...
            "travel-title" to "<#46d9ee>Перемещения",
        ...
        internal val COMMANDS = linkedMapOf(
            ...
            "dungeons" to HelpCenterCommandText("Подземелья", "Меню подземелий и боссов", "данж боссы элитные мобы"),
            "dungeon-portals" to HelpCenterCommandText("Порталы подземелий", "Телепорт к порталам приключений", "данж портал гильдия"),
