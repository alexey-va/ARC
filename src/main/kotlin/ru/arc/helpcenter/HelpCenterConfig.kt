...
class HelpCenterConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "root-body" to "<#e5f1f5>Всё нужное для игры — в одном месте.<newline><#9aaab2>Выберите раздел или <#b68cff>опишите задачу обычной фразой<#9aaab2>.",
            "my-label" to "<#b68cff>Про меня",
            ...
            "commands-label" to "<#b68cff>Команды и поиск",
            ...
            "my-identity" to "<#ffc247><bold><player></bold><newline><#9aaab2>Сервер: <#4dd8f0><server><newline><#9aaab2>Ранг: <#b68cff><rank>",
            ...
            "my-rank-label" to "<#b68cff>Мой ранг",
            ...
            "my-skills-label" to "<#b68cff>Мои навыки",
            ...
            "category-progress-label" to "<#b68cff>Развитие",
            "category-social-label" to "<#e5f1f5>Общение и сервер",
