...
class HelpCenterConfig(private val config: Config) {
    ...
    companion object {
        ...
        private val DEFAULT_TEXT = linkedMapOf(
            ...
            "root-body" to "<#d8cec5>Всё нужное для игры — в одном месте.<newline><#9b8f85>Выберите раздел или <#c6a7e8>опишите задачу обычной фразой<#9b8f85>.",
            "my-label" to "<#c6a7e8>Про меня",
            "my-tooltip" to "<#d8cec5>Ваш профиль, дома, поселения и прогресс.",
            "guide-label" to "<#f4bd6a>С чего начать",
            "guide-tooltip" to "<#d8cec5>Первые шаги без лишних команд.",
            "commands-label" to "<#c6a7e8>Команды и поиск",
            "commands-tooltip" to "<#d8cec5>Найти действие обычной фразой.",
            "travel-label" to "<#8fc7d8>Перемещения",
            "travel-tooltip" to "<#d8cec5>Дома, миры, варпы и возврат.",
            "privat-label" to "<#9fc9b0>Поселения",
            "privat-tooltip" to "<#d8cec5>Создание, территория, участники и подробный гайд.",
            "main-menu-label" to "<#b7a899>Главное меню",
            "main-menu-tooltip" to "<#d8cec5>Открыть остальные игровые разделы сервера.",
            "back-label" to "<#b7a899>Назад",
            "root-label" to "<#b7a899>К разделам",
            "not-available" to "—",
            "my-title" to "<#f4bd6a><bold>Про меня",
            "my-loading" to "<#d8cec5>Собираю ваш профиль…",
            "my-identity" to "<#f4bd6a><bold><player></bold><newline><#8fc7d8><server><#756b63> · <#c6a7e8>ранг <rank>",
            "my-summary" to "<#9b8f85>Баланс: <#f0a9c6><balance><newline><#9b8f85>Дома: <#8fc7d8><homes>/<max_homes><#756b63> · <#9b8f85>Поселения: <#9fc9b0><lands>",
            "my-location" to "<#9b8f85>Сейчас: <#8fc7d8><world><newline><#d8cec5><x>, <y>, <z>",
            "my-error" to "<#d8cec5>Часть профиля сейчас недоступна. Быстрые разделы всё равно работают.",
            "my-homes-label" to "<#8fc7d8>Мои дома",
            "my-homes-tooltip" to "<#d8cec5>Сохранённые точки и перемещения.",
            "my-lands-label" to "<#9fc9b0>Мои поселения",
            "my-lands-tooltip" to "<#d8cec5>Территория, участники и настройки.",
            "my-rank-label" to "<#c6a7e8>Мой ранг",
            "my-rank-tooltip" to "<#d8cec5>Текущий ранг и следующие цели.",
            "my-jobs-label" to "<#f4bd6a>Мои работы",
            "my-jobs-tooltip" to "<#d8cec5>Профессии, уровни и заработок.",
            "my-quests-label" to "<#f0a9c6>Мои задания",
            "my-quests-tooltip" to "<#d8cec5>Активные задания и награды.",
            "my-skills-label" to "<#c6a7e8>Мои навыки",
            "my-skills-tooltip" to "<#d8cec5>Открыть навыки и их развитие.",
            ...
            "vanilla-label" to "<#8fc7d8>Обычный мир",
            "mining-label" to "<#8fc7d8>Мир добычи",
            "biomes-label" to "<#9fc9b0>Мир новых биомов",
            "jobs-label" to "<#f4bd6a>Выбрать работу",
            "rules-label" to "<#c6a7e8>Правила",
            ...
            "category-travel-label" to "<#8fc7d8>Перемещения",
            "category-protection-label" to "<#9fc9b0>Защита",
            "category-trade-label" to "<#f0a9c6>Торговля",
            "category-progress-label" to "<#c6a7e8>Развитие",
            "category-social-label" to "<#d8cec5>Общение и сервер",
            ...
            "warps-label" to "<#8fc7d8>Варпы игроков",
            "spawn-label" to "<#8fc7d8>Спавн",
            "rtp-label" to "<#8fc7d8>Случайное место",
            "back-command-label" to "<#b7a899>Вернуться назад",
            "stuck-label" to "<#f4bd6a>Выбраться на спавн",
            "public-homes-label" to "<#8fc7d8>Публичные дома",
