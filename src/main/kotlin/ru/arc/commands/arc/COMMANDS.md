...
Внутренний bridge для межсерверного перехода. ARC хранит в
...
Необязательный третий аргумент оставлен только для совместимости со старым
Denizen bridge. Вручную игрокам эта команда не нужна.
