...
Без аргументов игрок открывает общую книгу с вкладками «Все», «Кузница»,
«Банк» и «Гильдия». Просмотр условий доступен без ресурсов и вне спавна;
NPC открывают сразу свою вкладку через `open <группа>`. `status` сохраняет
